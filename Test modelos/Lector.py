...
#ESTTE ES PARA MODIFICAR Y HACER PRUEBAS
...
# este valor puede mejorar consiguiendo un mejor entrenamiento supongo que cambiando los hiperparametros o mejorando el dataset
    ...
    def __call__(self):
        ...
        input_images_path = "D:\Escritorio\tfg\capturas\lp_uc3m_ocr\images\train"
        files_names = os.listdir(input_images_path)
        print(files_names)
        output_images_path = "D:\Escritorio\tfg\capturas\output"
